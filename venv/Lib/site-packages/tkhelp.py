...
def textf():
    ...
    txtl = tkinter.Label(text, text="Ein grosses Feld zum anzeigen bzw. eingeben von Daten.\n Viele Optionen sind waehlbar\n text = tkinter.Text(root)")
...
def scrolledtextboxf():
    ...
    scrolltxtl = tkinter.Label(scrolltext, text="Ein Textfield das der Groesse anpassbar ist, ich meine einen Schieberegler.\n auch mit Farben geht es um \n scrolledtext = tkinter.scrolledtext.ScrolledText(root)")
    ...
    scrolltxt.insert("end", "Hallo liebe Python Freunde,\ndiese ScrolledTextbox wird oft fuer Chatanwendungen und desgleichen genutzt,\nsozusagen als Logfile die nachher abgespeichert oder verworfen werden kann.", "u")
    
def listboxf():
    listbox = tkinter.Toplevel(bg = "lightblue", bd = 2, relief = "sunken", height = 200, width = 100)
    listbox.title("Widget: Listbox")
    listl = tkinter.Label(listbox, text="Die Listbox ist eine ganz einfache Liste, deren Werte ausgelesen werden koennen,\nnur einmal auswahl moeglich\n listbox = tkinter.Listbox(root)\n listbox.insert([string]) ")
...
def radiobuttonf():
    ...
    radl = tkinter.Label(radiobutton, text="Der Radiobutton wird oft in 2 oder mehrteiligen Grupen gefuehrt. Zum Auswaehlen eines Punktes,\nnur einmal auswahl moeglich\n radiobutton = tkinter.Radiobutton(root, text=[string], value=[string], variable=[string])")
...
def menuf():
  ...
  ml = tkinter.Label(menu, text="Das Menu-Widget ist ein sehr geschaetztes Widget.\n Dadurch erstellt man die Menus die ueberall zu finden sind!")
...
def canvasf():
    ...
    canl = tkinter.Label(canvas, text="Auf dieser Flaeche kann man zeichnen oder auch ein Bild anzeigen, In einem normalen Fenster.\n canvas = tkinter.Canvas(root, width=200, height=200)")
...
menu = tkinter.Button(butframe, text="Menu", command=__menuf)
spinbox = tkinter.Button(butframe, text="SpinBox", command=__spinboxf)
canvas = tkinter.Button(butframe, text="Canvas", command=__canvasf)
label = tkinter.Button(butframe, text="Label", command=__labelf)
checkbutton = tkinter.Button(butframe, text="CheckButton", command=__checkbuttonf)
...
copyright = tkinter.Button(footer, text="(c) by Logander4 Tutorials :: RC1 1.5", command=__copyright, relief="groove")
copyright.pack()
